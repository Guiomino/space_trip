 ...
 */
final class Version20231111131909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE means_of_transport (id INT AUTO_INCREMENT NOT NULL, model VARCHAR(50) NOT NULL, engine_type VARCHAR(80) NOT NULL, power_system VARCHAR(80) NOT NULL, navigation_system VARCHAR(80) NOT NULL, survival_system VARCHAR(80) NOT NULL, antirad_system VARCHAR(80) NOT NULL, max_speed INT NOT NULL, autonomy VARCHAR(80) NOT NULL, pressurization VARCHAR(80) NOT NULL, off_road_capability VARCHAR(80) NOT NULL, altitude VARCHAR(80) NOT NULL, underwater_map_system VARCHAR(80) NOT NULL, capacity INT NOT NULL, image VARCHAR(150) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, email VARCHAR(80) NOT NULL, password_hash LONGTEXT NOT NULL, rgpd TINYINT(1) NOT NULL, is_connected TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
