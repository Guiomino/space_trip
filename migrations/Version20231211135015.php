 ...
 */
final class Version20231211135015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activities (id INT AUTO_INCREMENT NOT NULL, resort_id INT NOT NULL, name VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(150) DEFAULT NULL, INDEX IDX_B5F1AFE57A3ABE5D (resort_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE resort (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, place VARCHAR(80) NOT NULL, area NUMERIC(10, 2) NOT NULL, starting_price NUMERIC(10, 2) NOT NULL, order_number INT NOT NULL, stars VARCHAR(5) NOT NULL, image VARCHAR(150) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE stay (id INT AUTO_INCREMENT NOT NULL, resort_id INT NOT NULL, extra_activities_id INT NOT NULL, accommodation_id INT NOT NULL, user_id INT NOT NULL, duration_weeks INT NOT NULL, number_of_travelers INT NOT NULL, check_in DATE NOT NULL, check_out DATE NOT NULL, date_time DATETIME NOT NULL, total_amount NUMERIC(10, 2) NOT NULL, INDEX IDX_5E09839C7A3ABE5D (resort_id), INDEX IDX_5E09839CB12E89EB (extra_activities_id), INDEX IDX_5E09839C8F3692CD (accommodation_id), INDEX IDX_5E09839CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE activities ADD CONSTRAINT FK_B5F1AFE57A3ABE5D FOREIGN KEY (resort_id) REFERENCES resort (id)');
        ...
        $this->addSql('ALTER TABLE stay ADD CONSTRAINT FK_5E09839C7A3ABE5D FOREIGN KEY (resort_id) REFERENCES resort (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activities DROP FOREIGN KEY FK_B5F1AFE57A3ABE5D');
        ...
        $this->addSql('ALTER TABLE stay DROP FOREIGN KEY FK_5E09839C7A3ABE5D');
